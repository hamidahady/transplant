...
PRI_PAYMENT_CTRY_TCR
PRI_PAYMENT_CTRY_TRR
PRI_PAYMENT_TCR
PRI_PAYMENT_TRR


base[c("ETHCAT","ETHCAT_DON","GENDER","GENDER_DON","PROC_TY_HR","SHARE_TY","EDUCATION","ETHCAT","ETHCAT_DON",
       "ETHNICITY","PRI_PAYMENT_CTRY_TCR", "PRI_PAYMENT_CTRY_TRR","PRI_PAYMENT_TCR", "PRI_PAYMENT_TRR")]<-NULL
  
  
table(heart.df.cleaned$PRI_PAYMENT_TRR)
table(heart.df.cleaned$ETHCAT_DON)
table(heart.df.cleaned$ETHNICITY)
table(heart.df$BMIS)
