...
```{r , message=FALSE, cache=FALSE, error=FALSE}
 ...
 heart.df.cleaned[ c("WLHL", "WLHR", "WLIN" , "WLKI", "WLKP" ,"WLLI", "WLLU", "WLPA","WLPI","VAD_AT_LISTING",
                     ...
                     "OTHER_INF_OSTXT_DON","OTHER_INF_CONF_DON",
                     ...
                     "CMV_TEST_DON", "COD_LIV_DON" ,"COD_OSTXT_DON","DIABDUR_DON","EXERCISE_O2" ,"LIV_DON_TY","O2_REQ_CALC",
                     "OTH_DGN_OSTXT","PCO2_TRR","PRIOR_LUNG_SURG_TYPE_OSTXT_TRR","PRIOR_LUNG_SURG_TYPE_TRR","PRVTXDIF",
                     "RESUSCIT_DUR","RVAD_AT_LISTING", "RVAD_WHILE_LISTED","TRANSPLANT_COUNTRY","TXINT" ,"TXKID","TXLIV","TXLNG","TXPAN")]<-NULL
 ...
 heart.df.cleaned[ c("HIST_MI","END_BLU_FLG","END_CREAT","END_LLU_FLG","END_RLU_FLG","EDUCATION_DON",
                     ...
                     "INHALED_NO", "INHALED_NO_TRR","LVAD_AT_LISTING","LVAD_WHILE_LISTED","MULTIORG", "NON_HRT_DON","PGE_TRR",
                     "PO2_DONE_DON","PROS_INFUS_TCR","PROS_INFUS_TRR","PROSTACYCLIN_TCR","PULM_INF_CONF_DON","RECOV_OUT_US","REM_CD","RESIST_INF",
                     "TX_PROCEDUR_TY", "TX_TYPE", "TXED" , "TXHRT","VDRL_DON")]<-NULL
