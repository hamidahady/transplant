...
pool_num_clean<-c(pool_num_clean,"year0", "year1", "year2", "year3", "year4", "year5", "year6", "year7","year8", "year9", "year10")
pool_char_clean<-pool_char[which(pool_char %in% names(heart.df.cleaned))]
...
heart.df.cleaned2<-cbind(heart.df.cleaned_num,heart.df.cleaned_char,heart.df.cleaned[c("year0", "year1", "year2", "year3",
                                                                                      "year4", "year5", "year6", "year7","year8", "year9", "year10")])
names(heart.df.cleaned[!(names(heart.df.cleaned) %in% names(heart.df.cleaned2) )])

rm(list=c("heart.df.cleaned_temp"))
